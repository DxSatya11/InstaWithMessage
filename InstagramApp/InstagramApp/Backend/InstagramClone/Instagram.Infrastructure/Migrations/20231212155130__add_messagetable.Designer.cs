...
namespace Instagram.Infrastructure.Migrations
{
    ...
    [Migration("20231212155130__add_messagetable")]
    partial class _add_messagetable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Instagram.Domain.Models.Messaging", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Instagram.Domain.Models.Messaging", b =>
                {
                    b.HasOne("Instagram.Domain.Models.Follow", null)
                        .WithMany("MessagesSentByFollower")
                        .HasForeignKey("FollowId");

                    b.HasOne("Instagram.Domain.Models.Users", "Receiver")
                        .WithMany("ReceivedMessages")
                        .HasForeignKey("ReceiverUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Instagram.Domain.Models.Users", "Sender")
            ...
            modelBuilder.Entity("Instagram.Domain.Models.Follow", b =>
                {
                    b.Navigation("MessagesSentByFollower");
                });
